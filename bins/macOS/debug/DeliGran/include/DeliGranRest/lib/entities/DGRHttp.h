...
extern "C"
{
  ...
  typedef struct DGRHResponsesCodes {
    ...
    unsigned int HTTP_CONTENT_TOO_LARGE;
  ...
  typedef struct DGRHttp {
    DGRHttpHeaders (*getHeaders)(void);
    DGRHMethods (*getMethods)(void);
    DGUHashTable *(*getHTMethods)(void);
    DGRHResponsesCodes (*getResponsesCodes)(void);
    DGRHMediaTypes (*getMediaTypes)(void);
    DGRHNetworkTypes (*getNetworkTypes)(void);
    DGRHProtocols (*getProtocols)(void);
